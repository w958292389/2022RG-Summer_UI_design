...
//graphic ui
ext_client_custom_graphic_single_t init_ui_send_data(void);
ext_client_custom_graphic_single_t client_custom_graphic_single_t;

ext_client_custom_graphic_single_t init_ui_send_data()
{
    ext_client_custom_graphic_single_t return_val;
    graphic_data_struct_t graphic_data_t;

    //draw a line
    graphic_data_t.graphic_name[0] = 'l';
    graphic_data_t.graphic_name[1] = 'n';
    graphic_data_t.graphic_name[2] = 'e';
    graphic_data_t.operate_tpye = 1;
    graphic_data_t.graphic_tpye = 1;
    graphic_data_t.layer = 1;
    graphic_data_t.color = 0; 
    // graphic_data_t.start_angle = ;
    // graphic_data_t.end_angle =;
    graphic_data_t.width = 10;
    graphic_data_t.start_x = 10;
    graphic_data_t.start_y = 10;
    // graphic_data_t.radius =;
    graphic_data_t.end_x = 90;
    graphic_data_t.end_y = 90;

    return_val.grapic_data_struct = graphic_data_t;
    return return_val;
}
//end graphic ui
...
void init_referee_struct_data(void)
{
    ...
    memset(&student_interactive_data_t, 0, sizeof(ext_student_interactive_data_t));
		...
		//ui
    client_custom_graphic_single_t = init_ui_send_data();
    memset(&client_custom_graphic_single_t, 0, sizeof(ext_client_custom_graphic_single_t));
		//ui
}
